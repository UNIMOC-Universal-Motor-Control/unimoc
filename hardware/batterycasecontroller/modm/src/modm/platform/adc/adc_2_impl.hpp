...
void 
modm::platform::Adc2::setInjectedConversionTriggerEdge(ExternalTriggerEdge edge)
{
	...
	ADC2->JSQR = (ADC2->JSQR & ~ADC_JSQR_JEXTEN_Msk) 
		| std::to_underlying(edge);
}

bool
modm::platform::Adc2::setInjectedConversionTriggerSource(uint32_t source)
{
	if (source > 31) {
	...
	ADC2->JSQR = (ADC2->JSQR & ~ADC_JSQR_JEXTSEL_Msk) 
