...
void 
modm::platform::Adc5::setInjectedConversionTriggerEdge(ExternalTriggerEdge edge)
{
	...
	ADC5->JSQR = (ADC5->JSQR & ~ADC_JSQR_JEXTEN_Msk) 
		| std::to_underlying(edge);
}

bool
modm::platform::Adc5::setInjectedConversionTriggerSource(uint32_t source)
{
	if (source > 31) {
	...
	ADC5->JSQR = (ADC5->JSQR & ~ADC_JSQR_JEXTSEL_Msk) 
