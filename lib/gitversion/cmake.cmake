...
function (_CREATE_GIT_VERSION_FILE)
  ...
  EXECUTE_PROCESS(
    COMMAND "${CMAKE_COMMAND}" -E env
            "PYTHONPATH=${DIR_OF_GITVERSION_TOOL}/src"
            "${Python3_EXECUTABLE}" -m gitversionbuilder --lang cpp
            --dir "${CMAKE_CURRENT_SOURCE_DIR}"
            "${CMAKE_CURRENT_BINARY_DIR}/messmer_gitversion/gitversion/version.h"
  ...
  IF(NOT result EQUAL 0)
    MESSAGE(FATAL_ERROR
            "Error running messmer/git-version tool. Return code: ${result}\n"
            "${output}\n${error_output}")
  ENDIF()
